...
export function Tabs({
  ...
  const contextValue = useMemo(
    ...
    [current, layoutId, setValue, size, variant],
  );
  return (
    ...
    return (
      <button
        ...
        className={cn(
          ...
          size === "large" && "px-4 pb-3 pt-1.5 text-base min-h-12",
          active
            ? "text-foreground"
    ...
    <div className="relative shrink-0">
      ...
      <button
        ...
        className={cn(
          ...
          size === "large" && "min-h-11 px-5 py-2 text-base",
          "text-muted-foreground hover:text-foreground",
          radius,
          className,
        )}
