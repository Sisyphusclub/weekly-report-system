...
>(function AnimatedDropdownCheckboxItem(
  { className, children, indicatorSide = "left", ...props },
  ref,
) {
  return (
    ...
    >
      <span
        aria-hidden
        className={cn(
          "absolute grid size-5 place-items-center",
          indicatorSide === "left" ? "left-2.5" : "right-2.5",
        )}
      >
...
>(function AnimatedDropdownItemIcon({ className, ...props }, ref) {
  return (
    <span
      ...
      aria-hidden
      className={cn(
        "grid size-5 shrink-0 place-items-center text-muted-foreground [&_svg]:size-4",
        className,
      )}
      {...props}
    />
...
>(function AnimatedDropdownShortcut({ className, ...props }, ref) {
  return (
    <span
      ...
      aria-hidden
      className={cn(
        "ml-auto shrink-0 font-mono text-[10px] text-muted-foreground tracking-wide transition-colors duration-200 group-data-[highlighted]:text-foreground",
        className,
      )}
      {...props}
    />
